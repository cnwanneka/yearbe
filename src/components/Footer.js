        ...
        <div className="space-y-8 text-base leading-7">
          ...
          <section>
            ...
            <ol className="list-decimal pl-6 space-y-2">
              <li>Email <span className="font-mono">returns@yearbe.com</span> with your order number, the item(s) you wish to return, and the reason.</li>
          ...
          <section>
            ...
            <div className="rounded-2xl border p-4 sm:p-5 bg-gray-50">
              ...
              <p>Email: <span className="font-mono">support@yearbe.com</span> · Returns: <span className="font-mono">returns@yearbe.com</span></p>
